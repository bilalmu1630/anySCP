...
4. If your browser saves a ZIP file, open it and extract the app first.
5. Run the anySCP app file.
...
## 🛠️ How to Add a Connection

1. Open anySCP.
2. Choose the connection type you want.
3. Enter the server or storage details.
4. Save the connection.
5. Open it from your list.
...
3. Add your SSH, SFTP, or S3 details.
4. Open the connection.
5. Use the terminal or file manager for your task.
